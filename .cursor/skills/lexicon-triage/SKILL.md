---
name: lexicon-triage
description: Use when the user says "triage" or "recap" for an area, or wants to review how an area is going and update its memory. Not for processing meetings or transcripts.
---
