...
Modes:
  1. Stub: Create file with metadata only; you fill transcript later.
     python scripts/manual_ingest.py --stub --date YYYY-MM-DD --title "Title" --with-whom "Name" --area personal

  2. Full: Parse HiNotes-format transcript from file or stdin and write formatted file.
     python scripts/manual_ingest.py --date YYYY-MM-DD --with-whom "Name" --area personal [--transcript-file PATH]
...
def main():
    ...
    parser.add_argument("--area", dest="area", help="Area: personal, company, career, general, etc.")
