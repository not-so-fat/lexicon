---
name: lexicon-review
description: Use when the user says "review objectives", "weekly review", or asks how they are doing against goals or whether work is still aligned. Global across all areas — not the per-area triage.
---
